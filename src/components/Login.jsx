  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-2 sm:p-4" style={{ backgroundColor: "var(--primary)" }}>
      <div className="w-full max-w-5xl bg-white rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row max-h-[98vh] md:max-h-none">
        ...
        {/* Form Panel */}
        <div className="md:w-1/2 p-6 sm:p-8 md:p-12 flex items-center justify-center" style={{ backgroundColor: "var(--foreground)" }}>
          <form onSubmit={submit} className="w-full max-w-sm" noValidate>
            <h2 className="text-2xl sm:text-3xl font-bold" style={{ color: "var(--title)" }}>Sign in</h2>
            <p className="text-xs sm:text-sm mt-0.5 sm:mt-1" style={{ color: "var(--subtitle)" }}>
            ...
            <div className="mt-4 sm:mt-6 space-y-3 sm:space-y-4">
              <div>
                <label className="block text-xs sm:text-sm font-medium" style={{ color: "var(--title)" }}>
                  Email
                </label>
                <input
                  type="email"
              ...
              <div>
                ...
                <div className="mt-1 flex items-center rounded-xl border border-gray-200 bg-white px-3 sm:px-4 transition focus-within:border-gray-400 focus-within:bg-white focus-within:ring-2 focus-within:ring-gray-200">
                  <input
            ...
            <div className="flex items-center justify-between mt-3 sm:mt-4 text-xs sm:text-sm">
              <label className="flex items-center gap-2 text-gray-600 cursor-pointer hover:text-gray-800 transition" style={{ color: "var(--subtitle)" }}>
                <input
                  type="checkbox"
            ...
            <p className="mt-4 sm:mt-6 text-xs sm:text-sm text-center" style={{ color: "var(--subtitle)" }}>
