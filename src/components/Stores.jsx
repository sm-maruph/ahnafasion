...
const STORES = [
  {
    id: 1, name: "Ahnaf Fashion Gulshan", city: "Dhaka",
  ...
  {
    id: 2, name: "Ahnaf Fashion Dhanmondi", city: "Dhaka",
  ...
  {
    id: 3, name: "Ahnaf Fashion Bashundhara City", city: "Dhaka",
  ...
  {
    id: 4, name: "Ahnaf Fashion Agrabad", city: "Chittagong",
  ...
  {
    id: 5, name: "Ahnaf Fashion Zindabazar", city: "Sylhet",
  ...
  {
    id: 6, name: "Ahnaf Fashion Khulna", city: "Khulna",
...
function StoreCard({ store }) {
  return (
    <div className="rounded-xl border border-gray-100 overflow-hidden shadow-sm hover:shadow-lg transition-shadow" style={{ backgroundColor: "var(--foreground)" }}>
      <div className="aspect-[16/10] relative" style={{ backgroundColor: "var(--background)" }}>
        <img src={store.image} alt={store.name} loading="lazy" className="h-full w-full object-cover" onError={imgFallback} />
        <span className="absolute top-2 left-2 text-[11px] font-semibold px-2 py-0.5 rounded-full" style={{ backgroundColor: BRAND , color: "var(--button-text)" }}>
          {store.city}
        </span>
      </div>
      <div className="p-4">
        <h3 className="font-bold" style={{ color: "var(--title)" }}>{store.name}</h3>
        <p className="mt-2 flex items-start gap-2 text-sm" style={{ color: "var(--subtitle)" }}>
          <LocationOnOutlinedIcon style={{ fontSize: 18, color: "#9ca3af" }} />
          {store.address}
        </p>
        <p className="mt-1.5 flex items-center gap-2 text-sm" style={{ color: "var(--subtitle)" }}>
          <AccessTimeOutlinedIcon style={{ fontSize: 18, color: "#9ca3af" }} />
          {store.hours}
        </p>
        <a href={`tel:${store.phone}`} className="mt-1.5 flex items-center gap-2 text-sm" style={{ color: "var(--subtitle)", hover: { color: "var(--title)" } }} >
